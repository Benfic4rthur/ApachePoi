...
public class CriacaoDeExcelComApachePoi {
	public static void main(String[] args) throws IOException {
		...
		if (criartabela == 0) {
			...
			LocalDate dataNasceu3 = LocalDate.parse(pessoa3.getDataDeNascimentoString(), formatter3);
			...
			pessoa4.setDataDeNascimentoString("15/10/2012");
			DateTimeFormatter formatter4 = DateTimeFormatter.ofPattern("dd/MM/yyyy");
			LocalDate dataNasceu4 = LocalDate.parse(pessoa4.getDataDeNascimentoString(), formatter4);
