...
public class TrabalhandoComArquivosCsv {
		...
		try {
			...
			if (gerarquivo == 0) {
				...
				File arquivoFile = new File(
						"C:\\Users\\Arthur Benfica\\git\\AulasAvancadas\\AulasAvancadas\\src\\TrabalhandoComArquivos\\Lista de clientes.csv");
				...
				for (int pos = 0; pos < numPessoas; pos++) {
					...
					// Escreve as informações da pessoa no arquivo csv e o ; quebra por coluna
					escrever.write("Nome: " + pessoa.getNomeString() + ";" + "e-mail: " + pessoa.getEmailString()
							+ ";" + "Data de Nascimento: " + pessoa.getDataDeNascimentoString() + ";" + "Idade: "
							+ pessoa.getIdade() + "\n");
				}
